 ...
 *
 */
public class InsightsStorageSchemaV1 extends StorageSchema {
    ...
    public InsightsStorageSchemaV1(String dbType, int schemaVersion) {
        ...
        initStatementList
            .add(
                "CREATE TABLE %s.GI_SCA_GROUPS (TENANT_ID VARCHAR(36) NOT NULL, WKSP_ID VARCHAR(64) NOT NULL, GROUP_ID VARCHAR(36) NOT NULL, "
                    + "REV_NO INTEGER DEFAULT 0 NOT NULL, REF_COL_NAME VARCHAR(128) NOT NULL, REF_COL_ID VARCHAR(64) NOT NULL, "
        ...
        initStatementList
            .add(
                "CREATE TABLE %s.GI_SCA_GROUP_COLUMNS (TENANT_ID VARCHAR(36) NOT NULL, WKSP_ID VARCHAR(64) NOT NULL, GROUP_ID VARCHAR(36) NOT NULL, "
                    + "COL_ID VARCHAR(64) NOT NULL, REV_NO INTEGER DEFAULT 0 NOT NULL, COL_NAME VARCHAR(128), SIM_SCORE INTEGER, "
                    + "COL_LOCATION VARCHAR(128), COL_INFO " + clobDef + ", "
