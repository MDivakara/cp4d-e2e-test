...
@ApiModel(value = "SCAGetGroupEntityResponse")
public class SCAGetGroupEntityResponse {
    

    public SCAGetGroupEntityResponse(String num_of_cols, String num_of_datasets, String max_similarity,
