...
@ApiModel(value = "TaskGetMetdataResponse")
public class TaskGetMetdataResponse {
    
    public TaskGetMetdataResponse(String task_id, String task_type, String created_by, String created_at,
