...
public class TestConditionCompare {
    ...
    public final static Logger LOGGER = LoggerFactory.getLogger(TestConditionCompare.class);
	...
	public void test_compare() {
		...
		assertTrue("conditionobject3 not similar to  conditionobject", conditionobject.isSimilarTo(conditionobject3));
        LOGGER.info("Done");		
        } catch (JSONException e) {
            LOGGER.error("Error while test_compare", e);
            assertTrue("Error while test_compare", false);
